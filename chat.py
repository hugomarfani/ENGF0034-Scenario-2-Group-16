  ...
  def send_message(self):
    ...
    if message:  # Only process non-empty messages
      ...
      if bot_response:
        ...
        print(f"ChatGP: {bot_response}"
              )  # Also print bot's response to the terminal

      self.text_input.delete(
          0, tk.END)  # Clear the input field after sending the message
...
def start_chat_app():
  ...
  center_window(
      root, 800,
      800)  # Adjust width and height if different dimensions are desired
